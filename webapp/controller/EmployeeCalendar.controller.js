    ...
    return Controller.extend(
      "my.report.zmydisputes.controller.EmployeeCalendar",
      {
          ...
          oModel.read("/MySchedule", {
            success: function (oData) {
              ...
              aResults.forEach(function (item) {
                ...
                if (item.IsOt) {
                  sShiftName += that._getI18nText("txtOtSuffix", [
                    item.OtHours,
                  ]);
                } else {
                ...
                var oAppointment = {
                  ...
                  Text:
                    String(iStartHour).padStart(2, "0") +
                    ":" +
                    String(iStartMin).padStart(2, "0") +
                    " - " +
                    String(iEndHour).padStart(2, "0") +
                    ":" +
                    String(iEndMin).padStart(2, "0"),
        ...
        onAppointmentSelect: function (oEvent) {
          ...
          var sLogStart =
            String(dStart.getHours()).padStart(2, "0") +
            ":" +
            String(dStart.getMinutes()).padStart(2, "0");
          var sLogEnd =
            String(dEnd.getHours()).padStart(2, "0") +
            ":" +
            String(dEnd.getMinutes()).padStart(2, "0");

          var sOtInfoText = oAppt.IsOt
            ? this._getI18nText("txtOtYes") +
              (oAppt.OtHours ? " (" + oAppt.OtHours + "h)" : "")
          ...
          var oDetailData = {
            ...
            EmployeeInfo: this._getI18nText("txtEmpInfo", [
              oAppt.EmployeeName,
              oAppt.Pernr,
            ]),
            DeptId: oAppt.DeptId,
          ...
          var oDialog = new Dialog({
            ...
            content: [
              new VBox({
                ...
                items: [
                  new Label({
                    text: this._getI18nText("lblShiftCode"),
                    design: "Bold",
                  }),
                  ...
                  new Label({
                    text: this._getI18nText("lblShiftName"),
                    design: "Bold",
                  }),
                  ...
                  new Label({
                    text: this._getI18nText("lblWorkDate"),
                    design: "Bold",
                  }),
                  ...
                  new Label({
                    text: this._getI18nText("lblTime"),
                    design: "Bold",
                  }),
                  ...
                  new Label({
                    text: this._getI18nText("lblEmployee"),
                    design: "Bold",
                  }),
                  ...
                  new Label({
                    text: this._getI18nText("lblDept"),
                    design: "Bold",
                  }),
                  ...
                  new Label({
                    text: this._getI18nText("lblOvertime"),
                    design: "Bold",
                  }),
            ...
            content: [
              new VBox({
                ...
                items: [
                  ...
                  new Text({
                    text: this._getI18nText("txtEmpInfo", [
                      oAppt.EmployeeName,
                      oAppt.Pernr,
                    ]),
                  }).addStyleClass("sapUiSmallMarginBottom"),
                  new Label({
                    text: this._getI18nText("lblLeaveDate"),
                    design: "Bold",
                  }),
                  new Text({
                    text: oAppt.StartDate.toLocaleDateString("en-GB"),
                  }).addStyleClass("sapUiSmallMarginBottom"),
                  new Label({
                    text: this._getI18nText("lblShiftName"),
                    design: "Bold",
                  ...
                  new Label({
                    text: this._getI18nText("lblLeaveReason"),
                    required: true,
                    design: "Bold",
                  }),
                  oReason,
