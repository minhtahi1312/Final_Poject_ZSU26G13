...
], function (Controller, JSONModel, BusyIndicator, MessageBox,Dialog,
    Button,
    Text,
    TextArea,
    Label,VBox) {
...
var oDetailData = {
                ...
                DeptId: oAppt.DeptId,
                IsOtText: oAppt.IsOt ? "Có" + (oAppt.OtHours ? " (" + oAppt.OtHours + " giờ)" : "") : "Không"
            };
...
_openLeaveDialog: function (oAppt) {
    ...
    var oReason = new TextArea({
        ...
        growing: true,
        growingMaxLines: 6,
        placeholder: "Ví dụ: Nghỉ khám bệnh, việc gia đình, nghỉ phép cá nhân..."
    });
        ...
        content: [
            new VBox({
                ...
                items: [
                    ...
                    new Label({ text: "Nhân viên", design: "Bold" }),
                    new Text({ text: oAppt.EmployeeName + " (" + oAppt.Pernr + ")" }).addStyleClass("sapUiSmallMarginBottom"),

                    new Label({ text: "Ngày nghỉ", design: "Bold" }),
                    new Text({ text: oAppt.StartDate.toLocaleDateString('vi-VN') }).addStyleClass("sapUiSmallMarginBottom"),

                    new Label({ text: "Ca làm việc", design: "Bold" }),
                    new Text({ text: oAppt.ShiftName }).addStyleClass("sapUiSmallMarginBottom"),

                    new Label({ text: "Lý do nghỉ", required: true, design: "Bold" }),
                    oReason
                ]
            })
        ],
