    ...
    return Controller.extend(
      "my.report.zmydisputes.controller.EmployeeDisputes",
      {
        ...
        onSearch: function () {
          ...
          if (sRequestTypeKey) {
            aFilters.push(
              new Filter("RequestType", FilterOperator.EQ, sRequestTypeKey),
            );
          }
          ...
          if (oBinding) {
            ...
            oBinding.sort(new sap.ui.model.Sorter("WorkDate", true));
          }
        },
        ...
        onCancelDispute: function (oEvent) {
          ...
          if (sStatus === "APPROVED") {
            MessageBox.information(
              this._getI18nText("msgCannotCancelApproved"),
            );
            return;
          }
          if (sStatus === "REJECTED") {
            MessageBox.information(
              this._getI18nText("msgCannotCancelRejected"),
            );
            return;
          }
          if (sStatus === "CANCELLED") {
            MessageBox.information(
              this._getI18nText("msgCannotCancelCancelled"),
            );
            return;
          }
          if (sStatus !== "PENDING") {
            MessageBox.information(
              this._getI18nText("msgCannotCancelProcessed"),
            );
            return;
          }
